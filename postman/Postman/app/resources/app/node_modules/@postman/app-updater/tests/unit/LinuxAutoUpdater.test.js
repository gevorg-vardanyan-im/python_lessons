...
describe('linuxAutoUpdater', function () {
    ...
    describe('downloadUpdate', function () {
        ...
        it('should throw an error if the updateInfo.downloadURL is empty', () => {
            let appName = 'Postman',
                downloadURL = '',
                downloadDirectory = '/home/postman/Downloads/postman-app/';
        ...
        it('should throw an error if the updateInfo.downloadURL is not of type string', () => {
            let appName = 'Postman',
                downloadURL = 8675,
                downloadDirectory = '/home/postman/Downloads/postman-app/';
        ...
        it('should throw an error if the updateInfo.downloadDirectory is empty', () => {
            let appName = 'Postman',
                downloadURL = 'https://dl-beta.pstmn.io/download/version/6.7.0/linux_64',
                downloadDirectory = '';
        ...
        it('should throw an error if the updateInfo.downloadDirectory is not of type string', () => {
            let appName = 'Postman',
                downloadURL = 'https://dl-beta.pstmn.io/download/version/6.7.0/linux_64',
                downloadDirectory = 1;
